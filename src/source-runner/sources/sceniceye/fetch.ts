 ...
 * Scenic Eye Fetch
 *
 * JS-rendering fetch for scenicmind.co.uk/sceniceye.
 ...
 *
 * NOTE: sceniceye.co.uk is a frameset - we fetch the inner content at
 * scenicmind.co.uk/sceniceye directly.
 */
...
/**
 * Fetch Scenic Eye page using Puppeteer for JS rendering.
 * The site is client-rendered so we need a headless browser.
 */
export async function fetchScenicEyeSource(
  config: SourceConfig,
  _run: SourceRun
